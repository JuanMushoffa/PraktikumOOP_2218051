...
public class GUI_Limas extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        limas.setLuasAlas(Double.parseDouble(jTextField1.getText()));
        limas.tinggi =Double.parseDouble(jTextField2.getText());
        jTextField3.setText(Double.toString(limas.volumeLimas()));
